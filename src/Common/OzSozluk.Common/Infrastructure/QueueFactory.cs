...
public static class QueueFactory
{
    ...
    public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer,  //bu bir extension methodu
                                                        string exchangeName,
    ...
    public static EventingBasicConsumer EnsureQueue(this EventingBasicConsumer consumer,  //bu bir extension methodu
                                                        string queueName,
                                                        string exchangeName)
    {
